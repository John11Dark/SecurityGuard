...
class Led:
    ...
    def theaterChase(self, strip, color, wait_ms=500, iterations=100):
    ...
    def rainbow(self, strip, wait_ms=25, iterations=100):
    ...
    def rainbowCycle(self, strip, wait_ms=25, iterations=50):
    ...
    def customRGB(self, strip, wait_ms=100, iterations=150):
        for i in range(255 * iterations):
    ...
    def customRandomAnimation(self, strip, wait_ms=50, iterations=100):
        for i in range(255 * iterations):
            self.colorWipe(
                self.strip,
                Color(randomNumber(0, 255), randomNumber(i, 255), randomNumber(0, i)),
            )
            time.sleep(wait_ms / 1000.0)
            self.colorWipe(
                self.strip,
...
newLed = Led()
#
# newLed.colorWipe(newLed.strip, Color(0, 0, 0))
# newLed.ledIndex(8, 255, 255, 255)
##time.sleep(0.24)
# newLed.ledIndex(7, 255, 255, 255)
# time.sleep(0.24)
# newLed.ledIndex(6, 255, 255, 255)
##time.sleep(0.24)
# newLed.ledIndex(5, 255, 255, 255)
##time.sleep(0.24)
# newLed.ledIndex(4, 255, 255, 255)
##time.sleep(0.24)
# newLed.ledIndex(3, 12, 12, 122)
##time.sleep(0.24)
# newLed.ledIndex(2, 255, 255, 255)
# time.sleep(1.24)
# newLed.ledIndex(1, 255, 255, 255)
# time.sleep(2.24)
# newLed.colorWipe(newLed.strip, Color(0, 0, 0))
#
#
